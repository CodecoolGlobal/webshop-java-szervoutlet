...
class ProductDaoTest {
    ...
    private Product testProduct = new Product(1, "test", 1, "USD", "description", testProductCat, testSupplier);
    ...
    void testIsProductAdded() {
        productDao.add(new Product(2, "test", 2, "USD", "description", new ProductCategory(2, "name", "department", "description"), new Supplier(2, "test", "description")));
        List<Product> products = productDao.getAll();
    ...
    void testIsProductRemoved() {
        Product p = new Product(3, "test", 4, "USD", "description", new ProductCategory(3, "name", "department", "description"), new Supplier(3, "test", "description"));
        productDao.add(p);
        int id = p.getId();
